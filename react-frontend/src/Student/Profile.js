...
const Profile = () => {
    ...
    const fetchProfile = async () => {
        try {
            ...
            const response = await fetch("http://localhost:5168/api/studentapi/profile", {
                method: "POST",
                credentials: "include"
            });
    ...
    const handleUpdate = async () => {
        try {
            const response = await fetch("http://localhost:5168/api/studentapi/update", {
                method: "POST",
                headers: {
    ...
    const handleOutput = async () => {
        ...
        try {
            const response = await fetch("http://localhost:5168/api/studentapi/logout", {
                method: "POST",
                credentials: "include"
            });
